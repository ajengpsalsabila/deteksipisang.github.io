    ...
    <>
      <section className="mb-20">
        ...
        <div
          ...
          onDrop={handleDrop}
        >
          <div className="md:col-span-3 bg-[#373737] h-[420px] md:h-[420px] w-full flex items-center justify-center relative">
            {selectedImage ? (
              <>
                <img
                  src={
          ...
          <div className="rounded-3xl md:col-span-2 bg-[#181818] h-[420px] md:h-[420px] w-full flex flex-col items-center justify-center">
            <button
            ...
            <div className="flex flex-col items-center mt-4">
              ...
              />
              <label className="text-white mt-2">Texture:</label>
              <input
                type="text"
                value={texture}
                ...
                className="text-black rounded-md p-1"
              />
              <label className="text-white mt-2">Pore:</label>
              <input
                type="text"
                value={pore}
            ...
            <button
              className="bg-[#373737] font-bold text-white px-4 py-2 rounded-md hover:bg-opacity-50 transition-colors duration-100 mt-4"
